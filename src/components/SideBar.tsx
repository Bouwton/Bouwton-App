...
import { Accordion, Col, ColProps, Dropdown, Nav, Navbar, NavDropdown, NavItem, NavLink } from "react-bootstrap";
...
export const SideBar = (props: ColProps) => {
  ...
  return <Col {...props} className={props.className + " bg-primary"}>
